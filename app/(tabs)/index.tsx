...
export default function CalculatorScreen() {
  ...
  const [heightUnit, setHeightUnit] = useState<'cm' | 'ft'>(settings.unitSystem === 'imperial' ? 'ft' : 'cm');
  const [weightUnit, setWeightUnit] = useState<'kg' | 'lbs'>(settings.unitSystem === 'imperial' ? 'lbs' : 'kg');
  ...
  const heightDisplay = heightUnit === 'ft'
    ? (() => { const { feet, inches } = cmToFeetInches(heightCm); return feet * 12 + inches; })()
    : heightCm;
